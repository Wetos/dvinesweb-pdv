						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<select id="paid_by" name="paid_by[]" class="form-control paid_by select2" style="width:100%;">
										<option value="cash"><?= lang("cash"); ?></option>
										<option value="CC"><?php echo lang("cc"); ?></option> 
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									class="pa form-control kb-pad amount" autofocus />
								</div>
							</div>
						</div>
				</div>
