        ...
        <div class="text-center">
            ...
            <table class="table table-striped table-condensed">
                ...
                <tr>
                    ...
                    <th colspan="2" class="text-right"><?= $this->tec->formatMoney($inv->total); ?></th>
                </tr>
                <?php
                if ($inv->order_tax != 0) {
                ...
                if ($inv->total_discount != 0 OR $inv->order_tax != 0) {
                    echo '<tr><th colspan="2">' . lang("grand_total") . '</th><th colspan="2" class="text-right"><font size="1" />' . $this->tec->formatMoney($inv->total + $inv->order_tax - $inv->total_discount) . '</th></tr>';
                }
            ...
            if ($payments) {
                ...
                foreach ($payments as $payment) {
                    ...
                    if ($payment->paid_by == 'cash' && $payment->pos_paid) {
                        echo '<td><font size="2" />' . lang("paid_by") . ': ' . lang($payment->paid_by) . '</td>';
                        echo '<td><font size="2" />' . lang("amount") . ': ' . $this->tec->formatMoney($payment->pos_paid == 0 ? $payment->amount : $payment->pos_paid) . '</td>';
                        echo '<td><font size="2" />' . lang("change") . ': ' . ($payment->pos_balance > 0 ? $this->tec->formatMoney($payment->pos_balance) : 0) . '</td>';
                    }else{
                        ...
                        echo '<table class="table table-striped table-condensed"><tbody>';
                            echo '<tr>';
                                echo '<td><font size="2" />' . lang("paid_by") . ': ' . $payment_type . '</td>';
                                echo '<td><font size="2" />' . lang("amount") . ': ' . $this->tec->formatMoney($inv->total + $inv->order_tax - $inv->total_discount). '</td>';
                            echo '</tr>';
                        echo '</tbody></table>';
